    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ZoneOperators", x => new { x.ZoneId, x.OperatorId });
                    table.ForeignKey(
                        name: "FK_ZoneOperators_Operator_OperatorId",
                        column: x => x.OperatorId,
                        principalTable: "Operator",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ZoneOperators_Zones_ZoneId",
                        column: x => x.ZoneId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ZoneOperators_OperatorId",
                table: "ZoneOperators",
                column: "OperatorId");
